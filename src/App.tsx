...
import { Users, Search, BookOpen, School, FileSpreadsheet } from 'lucide-react';
import { Teacher, Course, ClassRoom, ApiResponse } from './types';
import TeacherTable from './components/TeacherTable';
import CourseTable from './components/CourseTable';
import ClassroomTable from './components/ClassroomTable';

type Tab = 'teachers' | 'courses' | 'classrooms';
